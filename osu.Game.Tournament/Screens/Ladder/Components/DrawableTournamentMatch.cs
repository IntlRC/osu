        ...
        private void updateTeams()
        {
            ...
            if (Match.ConditionalMatches.Count > 0)
            {
                foreach (var conditional in Match.ConditionalMatches)
                {
                    ...
                    bool team3Match = Match.Team3Acronym != null && conditional.Acronyms.Contains(Match.Team3Acronym);
                    bool team4Match = Match.Team4Acronym != null && conditional.Acronyms.Contains(Match.Team4Acronym);
